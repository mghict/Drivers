...
namespace Driver.Infrastructure.Migrations
{
    ...
    [Migration("20240209180902_AddImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Auto", b =>
                {
                    b.HasOne("Domain.Entities.AutoModel", "AutoModel")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Auto", "AutoModelId")
            ...
            modelBuilder.Entity("Driver.Domain.Entities.Document", b =>
                {
                    b.HasOne("Domain.Entities.Auto", null)
                        .WithOne("Image")
                        .HasForeignKey("Driver.Domain.Entities.Document", "AutoId")
                    ...
                    b.HasOne("Domain.Entities.Person", null)
                        .WithOne("Image")
                        .HasForeignKey("Driver.Domain.Entities.Document", "PersonId")
                        .OnDelete(DeleteBehavior.NoAction);
