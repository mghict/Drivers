...
namespace Driver.Infrastructure.Migrations
{
    ...
    [Migration("20240218200815_EditAutoEntity")]
    partial class EditAutoEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.AutoModel", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.AutoBrand", null)
                        .WithMany("Models")
                        .HasForeignKey("AutoBrandId1");
