...
namespace Driver.Infrastructure.Migrations
{
    ...
    [Migration("20240314151425_RecievedErrorDescription01")]
    partial class RecievedErrorDescription01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Driver.Domain.Entities.MapReverse", b =>
                {
                    ...
                    b.HasIndex(new[] { "Lat", "Lng" }, "IX_LatAndLng_MapReverse")
                        .IsUnique();

                    b.ToTable("MapReverse", "dbo");
                });
            ...
            modelBuilder.Entity("Driver.Domain.Entities.RecievedError", b =>
                {
                    ...
                    b.Property<int>("RecievedErrorDescriptionId")
                        .HasColumnType("int")
                    ...
                    b.HasIndex("RecievedErrorDescriptionId");
            ...
            modelBuilder.Entity("Driver.Domain.Entities.RecievedErrorDescription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Recieved_Error_Description");
                });
            ...
            modelBuilder.Entity("Driver.Domain.Entities.RecievedMission", b =>
                {
                    ...
                    b.Property<bool>("IsValidAddress")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Driver.Domain.Entities.RecievedWeight", b =>
                {
                    ...
                    b.Property<bool>("HasRecievedMission")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Driver.Domain.Entities.RecievedError", b =>
                {
                    ...
                    b.HasOne("Driver.Domain.Entities.RecievedErrorDescription", "RecievedErrorDescription")
                        .WithMany()
                        .HasForeignKey("RecievedErrorDescriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Auto");

                    b.Navigation("RecievedErrorDescription");
                });
